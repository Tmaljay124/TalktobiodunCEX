...
import { Wallet, Loader2, Eye, EyeOff, Save, Copy, CheckCircle } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export default function WalletModal({ open, onOpenChange, wallet, fetchData }) {
